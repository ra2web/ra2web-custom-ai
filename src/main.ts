...
import { RA2WEBCustomBot } from "./bot/bot.js";
...
async function main() {
    ...
    */
    ...
    const onlineSettings: CreateOnlineOpts = {
        ...
        agents: [
            new RA2WEBCustomBot(process.env.ONLINE_BOT_NAME ?? botName1, Countries.RUSSIA),
    ...
    const offlineSettings1v1: CreateOfflineOpts = {
        ...
        online: false,
        agents: [
            new RA2WEBCustomBot(botName1, Countries.RUSSIA, [], true).setDebugMode(true),
            new RA2WEBCustomBot(botName2, Countries.FRANCE),
        ],
    };
    ...
    const offlineSettings2v2: CreateOfflineOpts = {
        ...
        online: false,
        agents: [
            new RA2WEBCustomBot(botName1, Countries.FRANCE, [botName2], false),
            new RA2WEBCustomBot(botName2, Countries.RUSSIA, [botName1], true).setDebugMode(true),
            new RA2WEBCustomBot(botName3, Countries.RUSSIA, [botName4], false),
            new RA2WEBCustomBot(botName4, Countries.FRANCE, [botName3], false),
        ],
    };
    ...
    const offlineSettings4v4: CreateOfflineOpts = {
        ...
        online: false,
        agents: [
            new RA2WEBCustomBot(botName1, Countries.FRANCE, team1, false),
            new RA2WEBCustomBot(botName2, Countries.RUSSIA, team1, true).setDebugMode(true),
            new RA2WEBCustomBot(botName3, Countries.RUSSIA, team1, false),
            new RA2WEBCustomBot(botName4, Countries.FRANCE, team1, false),
            new RA2WEBCustomBot(botName5, Countries.FRANCE, team2, false),
            new RA2WEBCustomBot(botName6, Countries.RUSSIA, team2, false),
            new RA2WEBCustomBot(botName7, Countries.RUSSIA, team2, false),
            new RA2WEBCustomBot(botName8, Countries.FRANCE, team2, false),
        ],
    };
